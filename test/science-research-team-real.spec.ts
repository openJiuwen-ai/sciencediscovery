 ...
 */
test("TC-E2E-01 research team with custom Specialist and MCP signoff", { tag: ["@real","@category:e2e","@os:linux","@arch:amd64","@model:real","@sandbox:bubblewrap"] }, async ({ page, journey }, info) => {
