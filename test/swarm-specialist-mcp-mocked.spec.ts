 ...
 */
test("Custom Specialist receives dedicated MCP and returns results through Swarm", { tag: "@mocked" }, async ({ page, journey }, testInfo) => {
  testInfo.skip(process.env.E2E_SWARM_TASK !== "1", "BLOCKED: requires Swarm with platform task delegation");
