 ...
 */
test(`${scenario} offline literature source contract`, { tag: "@mocked" }, async ({ page, journey }, info) => {
  info.skip(process.env.E2E_SWARM_TASK !== "1" || process.env.E2E_LITERATURE_FIXTURE !== "1", "BLOCKED: requires dedicated offline literature API fixture and Swarm");
