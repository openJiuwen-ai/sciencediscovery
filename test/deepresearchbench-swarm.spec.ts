...
import { selectedDrbSamples } from "./benchmarks/deepresearchbench/samples.ts";
 ...
 */
for (const sample of selectedDrbSamples()) {
  ...
  test(`DRB-${sample.id} ${sample.difficulty} Swarm research integration`, { tag: "@real" }, async ({ journey, page }, testInfo) => {
