...
test("renders inherited effective values and their field sources", () => {
  ...
  assert.match(html, /Inherit · Primary model · test-model · OpenAI standard · Auto \(Global setting\)/);
...
test("renders Global settings as direct defaults without inheritance or skill controls", () => {
  ...
  assert.match(html, /<option value="model-1" selected="">Primary model · test-model · OpenAI standard · Auto<\/option>/);
...
test("disambiguates duplicate model options without removing either profile", () => {
  ...
  assert.match(html, /Primary model · test-model · OpenAI standard · Auto · model-1/);
  assert.match(html, /Primary model · test-model · OpenAI standard · Auto · model-…2222/);
  ...
  assert.match(inheritedHtml, /Inherit · Primary model · test-model · OpenAI standard · Auto · model-1 \(Global setting\)/);
});
