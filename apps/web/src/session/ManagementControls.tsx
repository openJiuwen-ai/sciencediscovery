...
import type { ConnectorManifest, DeletionImpact, ModelProfile, RuntimeSettingsDetails, RuntimeSettingsOverrides, SessionListState, SkillDescriptor, SkillLibrary } from "@science-agent/schema";
