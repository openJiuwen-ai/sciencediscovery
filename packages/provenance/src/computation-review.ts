...
export interface MemoryGraphReviewPort {
  byEdgeType(edgeTypes: Array<"extracts">, sessionId?: string): Promise<MemoryGraphByEdgeResult>;
}
...
export function createEvidenceReferenceTracer(
  memoryGraphClient: MemoryGraphReviewPort | null | undefined,
  sessionId: string,
  ...
  let extractedFromQuery: Promise<MemoryGraphByEdgeResult> | undefined;
